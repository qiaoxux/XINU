...
struct	pentry	{
	...
	int pnewprocess;	/* mark new process		*/
	int pnewprio;	/* new priotiry		*/
	int pquantum;	/* CPU ticks the process can run		*/
	int pcounter;	/* left quantum value in one epoch		*/
	int pgoodness;	/* goodness value to order ready queue		*/
